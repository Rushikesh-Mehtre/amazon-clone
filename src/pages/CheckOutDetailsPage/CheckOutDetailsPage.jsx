...
import { emptyCart } from "../../features/AddedToCartProducts/AddedToCartProductsSlice";
      ...
      <div className={styles.bottom}>
        <div className={styles.left}>
          <div className={styles.section}>
            <p className={styles.head}>1 &nbsp; Select a delivery address</p>
            <div className={styles.content}>
              ...
              <div className={address === "address1" ? styles.selected : ""}>
                <input
                  ...
                  name="address"
                  value="address1"
                  onClick={(e) => addressHandler(e.target.value)}
                />{" "}
                <label htmlFor="">
                  Room No 18, 2nd Flr, Mandvi Chambers, 184, Samuel Street, Masjid Bunder(e),Mumbai,Maharashtra,Phone
                  number - 02223443418
                </label>
              </div>
              <div className={address === "address2" ? styles.selected : ""}>
                <input
                  type="radio"
                  checked={address === "address2"}
                  name="address"
                  value="address2"
                  onClick={(e) => addressHandler(e.target.value)}
                />{" "}
                <label htmlFor="">
                  107 Avanti Chambers R C Dutt Road, B/h Express Hotel R C Dutt Road,Mumbai,Maharashtra,Phone number -
                  02223443418
                </label>
              </div>
            </div>
          ...
          <div className={styles.section}>
            <p className={styles.head}>2 &nbsp; Payment method</p>
            <div className={styles.content}>
              <p className={styles.contentHead}>Most recently used</p>
              <div className={paymentMethod === "COD" ? styles.selected : ""}>
                <input type="radio" name="paymentMethod" onClick={(e) => paymentHandler(e.target.value)} value="COD" />{" "}
              ...
              <div className={paymentMethod === "netBanking" ? styles.selected : ""}>
                <input
                  type="radio"
                  name="paymentMethod"
                  onClick={(e) => paymentHandler(e.target.value)}
                  value="netBanking"
                />{" "}
          ...
          <div className={styles.section}>
            <p className={styles.head}>3 &nbsp; Items and delivery</p>
            <div className={styles.content}>
              <p className={styles.contentHead}>
                Delivery date: <span className={styles.date}>7 July 2022</span>{" "}
              </p>
              <p>If you order in the next 20 hours and 21 minutes ( Details )</p>
                ...
                <div key={item.id} className={styles.items}>
                  ...
                  <div className={styles.deliveryDetails}>
                    ...
                    <p>
                      ...
                      <span>
                        {" "}
                        <span className={styles.day}>Thursday</span> — FREE Delivery with Prime
                      </span>
                    </p>
                  </div>
                </div>
